...
namespace RaspberryPi.Mqtt {
	public class MqttClientService : IMqttClientService, IDisposable, IAsyncDisposable {
		public bool Enabled => _options.Enabled;
		public bool Connected => _client?.IsConnected ?? false;
		public IReadOnlyDictionary<string, MqttTopic> Topics => _topics;

		private readonly MqttClientServiceOptions _options;
		private readonly ILogger<IMqttClientService> _logger;
		private readonly MqttFactory _factory;
		private readonly Dictionary<string, MqttTopic> _topics;
		private IMqttClient _client;

		public MqttClientService(IOptions<MqttClientServiceOptions> options, ILogger<IMqttClientService> logger) {
